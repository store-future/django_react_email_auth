...
SECRET_KEY = 'django-insecure-j4s8bz0((mu+&wz1s*y7bp=194a(*l1wl21boq_x_-n(@fknr3'
...
#     'api.auth_backends.EmailAuthBackend',  # Custom backend using email
# ]

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_HOST_USER = 'dhananjayasharma43@gmail.com'
